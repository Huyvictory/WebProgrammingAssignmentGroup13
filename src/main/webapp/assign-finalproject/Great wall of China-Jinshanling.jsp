...
<!-- Start All Title Box -->
    <div class="all-title-box">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2>Great wall of China, Jinshanling</h2>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-xl-5 col-lg-5 col-md-6">
                    <div id="carousel-example-1" class="single-product-slider carousel slide" data-ride="carousel">
                        <div class="carousel-inner" role="listbox">
                            <div class="carousel-item active"> <img class="d-block w-100" src="images/great-wall-of-china1.jpg" alt="First slide"> </div>
                            <div class="carousel-item"> <img class="d-block w-100" src="images/great-wall-of-china2.jpg" alt="Second slide"> </div>
                            <div class="carousel-item"> <img class="d-block w-100" src="images/great-wall-of-china3.jpg" alt="Third slide"> </div>
                        </div>
                        ...
                        <ol class="carousel-indicators">
                            <li data-target="#carousel-example-1" data-slide-to="0" class="active">
                                <img class="d-block w-100 img-fluid" src="images/great-wall-of-china1.jpg" alt="" />
                            </li>
                            <li data-target="#carousel-example-1" data-slide-to="1">
                                <img class="d-block w-100 img-fluid" src="images/great-wall-of-china2.jpg" alt="" />
                            </li>
                            <li data-target="#carousel-example-1" data-slide-to="2">
                                <img class="d-block w-100 img-fluid" src="images/great-wall-of-china3.jpg" alt="" />
                            </li>
                        </ol>
                    </div>
                </div>
                <div class="col-xl-7 col-lg-7 col-md-6">
                    <div class="single-product-details">
						...
						Jinshanling was built from 1570 CE during the Ming dynasty.</p>
						<p>The Jinshanling section of the Great Wall is 10.5 km long with 5 passes, 67 towers and 3 beacon towers.
						...
						The entrance fee is 65 RMB. A cable car (40 RMB) has been constructed to take visitors to the highest point along the wall. 
						There is an additional admission charge of 50 RMB to continue on to the Simatai section, and a 5 RMB fee to cross the suspension bridge.</p>
