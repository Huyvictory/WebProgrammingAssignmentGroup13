...
<!-- Start All Title Box -->
    <div class="all-title-box">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2>Japan cherry blossom season</h2>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-xl-5 col-lg-5 col-md-6">
                    <div id="carousel-example-1" class="single-product-slider carousel slide" data-ride="carousel">
                        <div class="carousel-inner" role="listbox">
                            <div class="carousel-item active"> <img class="d-block w-100" src="images/japan1.jpg" alt="First slide"> </div>
                            <div class="carousel-item"> <img class="d-block w-100" src="images/japan2.jpg" alt="Second slide"> </div>
                            <div class="carousel-item"> <img class="d-block w-100" src="images/japan3.jpg" alt="Third slide"> </div>
                        </div>
                        ...
                        <ol class="carousel-indicators">
                            <li data-target="#carousel-example-1" data-slide-to="0" class="active">
                                <img class="d-block w-100 img-fluid" src="images/japan1.jpg" alt="" />
                            </li>
                            <li data-target="#carousel-example-1" data-slide-to="1">
                                <img class="d-block w-100 img-fluid" src="images/japan2.jpg" alt="" />
                            </li>
                            <li data-target="#carousel-example-1" data-slide-to="2">
                                <img class="d-block w-100 img-fluid" src="images/japan3.jpg" alt="" />
                            </li>
                        </ol>
                    </div>
                </div>
                <div class="col-xl-7 col-lg-7 col-md-6">
                    <div class="single-product-details">
                        <h2>japan cherry blossom season</h2>
                        <h5> <del>$ 75.00</del> $69.79</h5> 
                        <!--<p class="available-stock"><span> 20 available / <a href="#">8 sold </a></span><p> -->
						<h4>Description:</h4>
						<p>Japan's cherry blossom season famously begins in April and lasts for around two weeks. 
						The best places to see the blush-tinted blooms are in Maruyama Park, Mount Yishino, Himeji Castle and Fuji Five Lakes.</p>
						<p>Usually, the blooms burst into colour between mid-March and early May and kaleidoscopic cherry blossom erupts all over Japan, filling ornamental parks and framing city canals.
						Although these trees exist around the world, nowhere matches Japan’s annual pandemonium of pink petals. 
						But, if you can’t make full bloom, don’t fret. 
						Plan a trip in February, when the equally beautiful but lesser-known plum blossoms are on show.
						Keep an eye on this handy cherry blossom forecast to track when 2021 blooming is expected to start.</p>
