...
<body>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    ...
                    <div class="our-link">
                        <ul>
                            <li><a href="my-account.jsp"><i class="fa fa-usermodel s_color"></i><%out.println(email);%></a></li>
    ...
    <header class="main-header">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-default bootsnav">
			...
			<li class="nav-item"><a class="nav-link" href="my-account.jsp">Customer Service</a></li>
 			<!--
                        <li class="dropdown">
...
<!-- Start Shop Detail  -->
            ...
            <div class="row">
                <div class="col-xl-5 col-lg-5 col-md-6">
                    <div id="carousel-example-1" class="single-product-slider carousel slide" data-ride="carousel">
                        <div class="carousel-inner" role="listbox">
                            <div class="carousel-item active"> <img class="d-block w-100" src="images/lake-marian-NZ1.jpg" alt="First slide"> </div>
                            <div class="carousel-item"> <img class="d-block w-100" src="images/lake-marian-NZ2.jpg" alt="Second slide"> </div>
                            <div class="carousel-item"> <img class="d-block w-100" src="images/lake-marian-NZ3.jpg" alt="Third slide"> </div>
                        </div>
                        ...
                        <ol class="carousel-indicators">
                            <li data-target="#carousel-example-1" data-slide-to="0" class="active">
                                <img class="d-block w-100 img-fluid" src="images/lake-marian-NZ1.jpg" alt="" />
                            </li>
                            <li data-target="#carousel-example-1" data-slide-to="1">
                                <img class="d-block w-100 img-fluid" src="images/lake-marian-NZ2.jpg" alt="" />
                            </li>
                            <li data-target="#carousel-example-1" data-slide-to="2">
                                <img class="d-block w-100 img-fluid" src="images/lake-marian-NZ3.jpg" alt="" />
                            </li>
                        </ol>
                    </div>
                </div>
                <div class="col-xl-7 col-lg-7 col-md-6">
                    <div class="single-product-details">
						...
						<p>The lake is fed and drained by Marian Creek which in turn feeds into the Hollyford River. 
						Marian Creek's catchment upstream of Lake Marian includes several permanent snowfields in a cirque at the head of the valley northeast of the peak of Mount Crosscut.
						There the creek drains two smaller alpine lakes, Lake Mariana and Lake Marianette, followed by the 122 metres (400 ft) tall Lyttle Falls, before it reaches Lake Marian.</p>
						<div class="price-box-bar">
					<!--  		 <div class="cart-and-bay-btn">
								<a class="btn hvr-hover" data-fancybox-close="" href="cart.jsp">Add to cart</a>
							</div>  -->	
						</div>
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12">
                        <div class="footer-link">
                            ...
                            <ul>
                                ...
                                <li><a href="my-account.html">Customer Service</a></li>
    ...
    <div class="footer-copyright">
        <p class="footer-company">All Rights Reserved. &copy; 2021 <a href="#">ThewayShop</a></p>
    </div>
    <!-- End copyright  -->
