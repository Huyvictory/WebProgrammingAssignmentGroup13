            ...
            <div class="row">
                <div class="col-xl-5 col-lg-5 col-md-6">
                    <div id="carousel-example-1" class="single-product-slider carousel slide" data-ride="carousel">
                        <div class="carousel-inner" role="listbox">
                            <div class="carousel-item active"> <img class="d-block w-100" src="images/las_lajas3.jpg" alt="First slide"> </div>
                            <div class="carousel-item"> <img class="d-block w-100" src="images/las_lajas2.jpg" alt="Second slide"> </div>
                            <div class="carousel-item"> <img class="d-block w-100" src="images/las_lajas1.jpg" alt="Third slide"> </div>
                        </div>
                        ...
                        <ol class="carousel-indicators">
                            <li data-target="#carousel-example-1" data-slide-to="0" class="active">
                                <img class="d-block w-100 img-fluid" src="images/las_lajas3.jpg" alt="" />
                            </li>
                            <li data-target="#carousel-example-1" data-slide-to="1">
                                <img class="d-block w-100 img-fluid" src="images/las_lajas2.jpg" alt="" />
                            </li>
                            <li data-target="#carousel-example-1" data-slide-to="2">
                                <img class="d-block w-100 img-fluid" src="images/las_lajas1.jpg" alt="" />
                            </li>
                        </ol>
                    </div>
                </div>
                <div class="col-xl-7 col-lg-7 col-md-6">
                    <div class="single-product-details">
                        <h2>Las Lajas Cathedral - Colombia</h2>
                        <!--<h5> <del>$ 60.00</del> $40.79</h5> 
                        <p class="available-stock"><span> More than 20 available / <a href="#">8 sold </a></span><p> -->
						<h4>Description:</h4>
						<p>The National Shrine Basilica of Our Lady of Las Lajas (Spanish: Basílica Santuario Nacional de Nuestra Señora de las Lajas), commonly called Las Lajas Shrine (Santuario de Las Lajas), is a basilica church located in the southern Colombian Department of Nariño, in the municipality of Ipiales, and is built inside the canyon of the Guáitara River.</p>
                   				<p>The present church was built in a Gothic style between 1916 and 1949, taking up a total time frame of 33 years to build. The name Laja (slab) comes from the name of a type of flat sedimentary rock similar to shale and slate.</p>
