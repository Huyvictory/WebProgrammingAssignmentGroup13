...
<body>
    ...
    <div class="about-box-main">
        <div class="container">
            <div class="row">
		<div class="col-lg-6">
                    <div class="banner-frame"> <img class="img-fluid" src="images/losama-bay.jpg" alt="" />
                    </div>
                </div>
                <div class="col-lg-6">
                    <h2 class="noo-sh-title-top">LoSama Bay - ThaiLand </h2>
                    <p>Loh Sama (Sama Bay in Thai) is one of the most famous sites of Koh Phi Phi Leh which, we have to admit, hosts a fair deal of outstanding attractions.
		    Located on the eastern side of the southern tip of the island, it features a small islet in the centre of the bay and a tiny beach at the backside of a small canyon on its northern part. 
		    Loh Sama is reputed for its snorkelling and diving opportunities. The famous Maya Bay is separated from it by a limestone cliff, which is pierced by a small hole allowing passage at low tide. 
		    A wooden staircase and terrace has been built on the Maya Bay side, offering visitors a great vista over Loh Sama and the islet.</p>
                    <p>Snorkellers can enjoy the shallow crystal-clear waters of the channel formed between Koh Phi Phi Leh and the islet while scuba divers can appreciate wall diving down to 20 metres around the islet itself. 
		    Loh Sama is also famous for being a great night-diving spot, with a narrow canyon covered with soft coral and gorgonian sea fans offering spectacular scenery at night thanks to the light reflection in the eyes of hundreds of crustaceans crawling around.</p>
                </div>
            </div>
			...
			<div class="row">
				<div class="col-lg-6 col-md-6 col-sm-12">
					<div class="offer-box-products">
						<img class="img-fluid" src="images/losama-bay1.jpg" alt="" />
					</div>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-12">
					<div class="offer-box-products">
						<img class="img-fluid" src="images/losama-bay2.jpg" alt="" />
					</div>
				</div>
			</div>
		</div>
