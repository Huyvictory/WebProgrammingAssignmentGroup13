            ...
            <div class="row">
                <div class="col-xl-5 col-lg-5 col-md-6">
                    <div id="carousel-example-1" class="single-product-slider carousel slide" data-ride="carousel">
                        <div class="carousel-inner" role="listbox">
                            <div class="carousel-item active"> <img class="d-block w-100" src="images/south-korea1.jpg" alt="First slide"> </div>
                            <div class="carousel-item"> <img class="d-block w-100" src="images/south-korea2.jpg" alt="Second slide"> </div>
                            <div class="carousel-item"> <img class="d-block w-100" src="images/south-korea3.jpg" alt="Third slide"> </div>
                        </div>
                        ...
                        <ol class="carousel-indicators">
                            <li data-target="#carousel-example-1" data-slide-to="0" class="active">
                                <img class="d-block w-100 img-fluid" src="images/south-korea1.jpg" alt="" />
                            </li>
                            <li data-target="#carousel-example-1" data-slide-to="1">
                                <img class="d-block w-100 img-fluid" src="images/south-korea2.jpg" alt="" />
                            </li>
                            <li data-target="#carousel-example-1" data-slide-to="2">
                                <img class="d-block w-100 img-fluid" src="images/south-korea3.jpg" alt="" />
                            </li>
                        </ol>
                    </div>
                </div>
                <div class="col-xl-7 col-lg-7 col-md-6">
                    <div class="single-product-details">
                        <h2>South Korea</h2>
                        <h5> <del>$70.00</del> $65.79</h5> 
                        <!--<p class="available-stock"><span> 20 available / <a href="#">8 sold </a></span><p> -->
						<h4>Description:</h4>
						<p>South Korea (Korean: 한국/韓國, RR: Hanguk; literally 남한/南韓, RR: Namhan, or 남조선/南朝鮮, MR: Namchosŏn in North Korean usage), officially the Republic of Korea (ROK; Korean: 대한민국/大韓民國, RR: Daehan Minguk), is a country in East Asia, constituting the southern part of the Korean Peninsula, and sharing a land border with North Korea. 
						25 million people, around half of the country's population of more than 51 million people, live in the Seoul Capital Area, the fifth-largest metropolitan area in the world.</p>
						<p>South Korea is a highly developed country, ranking as the third-highest country on the Human Development Index in Asia.
						It is a member of the OECD's Development Assistance Committee, the G20 and the Paris Club. 
						Its economy ranks as the world's tenth-largest by nominal GDP. Its citizens enjoy one of the world's fastest Internet connection speeds. 
						The country is the world's fifth-largest exporter and eighth-largest importer. 
						South Korea was in 2017 the world's 7th largest emitter of carbon emissions and the 5th largest emitter per capita. 
						Since the 21st century, South Korea has been renowned for its influential pop culture, particularly in music (K-pop), TV dramas and cinema, a phenomenon referred to as the Korean Wave</p>
           ...
           <div class="row my-5">
                <div class="col-lg-12">
                    <div class="title-all text-center">
                        ...
                        <p>Some others tours from our website</p>
                    </div>
