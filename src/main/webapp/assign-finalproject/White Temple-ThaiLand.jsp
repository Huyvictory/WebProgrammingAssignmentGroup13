            ...
            <div class="row">
                <div class="col-xl-5 col-lg-5 col-md-6">
                    <div id="carousel-example-1" class="single-product-slider carousel slide" data-ride="carousel">
                        <div class="carousel-inner" role="listbox">
                            <div class="carousel-item active"> <img class="d-block w-100" src="images/white-temple1.jpg" alt="First slide"> </div>
                            <div class="carousel-item"> <img class="d-block w-100" src="images/white-temple2.jpg" alt="Second slide"> </div>
                            <div class="carousel-item"> <img class="d-block w-100" src="images/white-temple3.jpg" alt="Third slide"> </div>
                        </div>
                ...
                <div class="col-xl-7 col-lg-7 col-md-6">
                    <div class="single-product-details">
                        <h2>Wat Rong Khun - White Temple - ThaiLand</h2>
                        <h5> <del>$ 60.00</del> $40.00</h5> 
                        <!-- <p class="available-stock"><span> 20 available / <a href="#">8 sold </a></span><p> -->
						<h4>Description:</h4>
						<p>Wat Rong Khun (Thai: วัดร่องขุ่น), perhaps better known to foreigners as the White Temple, is a privately owned art exhibit in the style of a Buddhist temple in Chiang Rai Province, Thailand. It is owned by Chalermchai Kositpipat, who designed, constructed, and opened it to visitors in 1997.</p>
                   				<p>By the end of the 20th century, the original Wat Rong Khun was in a bad state of repair.
						Funds were not available for renovation. Chalermchai Kositpipat, a local artist from Chiang Rai, decided to completely rebuild the temple and fund the project with his own money.To date, Chalermchai has spent THB1,080 million on the project. The artist intends for the area adjacent to the temple to be a center of learning and meditation and for people to gain benefit from the Buddhist teachings. 
						Kositpipat considers the temple to be an offering to Buddha and believes the project will give him immortal life.Today the works are ongoing, but are not expected to be completed until 2070.</p>
