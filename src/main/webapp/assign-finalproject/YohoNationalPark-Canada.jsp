...
<!-- Start All Title Box -->
    <div class="all-title-box">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2>Yoho National Park - Canada</h2>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-xl-5 col-lg-5 col-md-6">
                    <div id="carousel-example-1" class="single-product-slider carousel slide" data-ride="carousel">
                        <div class="carousel-inner" role="listbox">
                            <div class="carousel-item active"> <img class="d-block w-100" src="images/yoho_national_park1.jpg" alt="First slide"> </div>
                            <div class="carousel-item"> <img class="d-block w-100" src="images/yoho_national_park2.jpg" alt="Second slide"> </div>
                            <div class="carousel-item"> <img class="d-block w-100" src="images/yoho_national_park3.jpg" alt="Third slide"> </div>
                        </div>
                        ...
                        <ol class="carousel-indicators">
                            <li data-target="#carousel-example-1" data-slide-to="0" class="active">
                                <img class="d-block w-100 img-fluid" src="images/yoho_national_park1.jpg" alt="" />
                            </li>
                            <li data-target="#carousel-example-1" data-slide-to="1">
                                <img class="d-block w-100 img-fluid" src="images/yoho_national_park2.jpg" alt="" />
                            </li>
                            <li data-target="#carousel-example-1" data-slide-to="2">
                                <img class="d-block w-100 img-fluid" src="images/yoho_national_park3.jpg" alt="" />
                            </li>
                        </ol>
                    </div>
                </div>
                <div class="col-xl-7 col-lg-7 col-md-6">
                    <div class="single-product-details">
                        <h2>Yoho National Park - Canada</h2>
                        <h5> <del>$ 85.00</del> $80.79</h5> 
                        <!--<p class="available-stock"><span> 20 available / <a href="#">8 sold </a></span><p> -->
						<h4>Description:</h4>
						<p>Yoho National Park (/ˈjoʊhoʊ/ YOH-hoh) is a national park of Canada in British Columbia. 
						It is located within the Rocky Mountains along the western slope of the Continental Divide of the Americas in southeastern British Columbia. 
						The word Yoho is a Cree expression of amazement or awe, and it is an apt description for the spectacular landscape of massive ice fields and mountain peaks that rank among the highest in the Canadian Rockies.
						Yoho NP is bordered by Kootenay National Park on the southern side and Banff National Park on the eastern side in Alberta.</p>
						<p>Yoho covers 1,313 square kilometres (507 sq mi), and it is the smallest of the four contiguous national parks. 
						...
						The park's administrative and visitor centre are located in Field, British Columbia, beside the Trans-Canada Highway.</p>
