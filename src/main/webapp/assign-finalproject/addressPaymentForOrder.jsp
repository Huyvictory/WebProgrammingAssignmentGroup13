...
%>
      	...
      	while(rs.next())
        {
         ...
         <%}
      	ResultSet rs2=st.executeQuery("select * from usermodels where email='"+email+"'");
         while(rs2.next()){ %>
        </tbody>
      </table>
...
<div class="left-div">
<h3>Mobile Number</h3>
<input class="input-style" type="text" name="numberMobile" value="<%=rs2.getString(3)%>" placeholder="Enter numberMobile" required>
