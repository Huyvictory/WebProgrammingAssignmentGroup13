...
<script src='https://kit.fontawesome.com/a076d05399.js'></script>
    ...
    <div class="topnav sticky">
            ...
            <h2><a href="product.jsp"><i class='fas fa-arrow-circle-left'>Products_Home</i></a></h2>
             <h2><a href="">Your Profile(<% out.println(email);%>) <i class='fas fa-usermodel-alt'></i></a></h2>
