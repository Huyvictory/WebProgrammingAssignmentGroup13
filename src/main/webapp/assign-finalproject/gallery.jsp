        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-default bootsnav">
            ...
            <div class="side">
                ...
                <li class="cart-box">
                    <ul class="cart-list">
                         <li>
                            <a href="myproduct.jsp" class="btn btn-default hvr-hover btn-cart">VIEW CART</a>
                           </li>    
                    </ul>
                </li>
            </div>
    ...
    <div class="products-box">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="title-all text-center">
                        <h1>Our Gallery</h1>
                        <p>All available individual tours are here.</p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="special-menu text-center">
                        <div class="button-group filter-button-group">
                            ...
                            <button data-filter=".attractive">Attractive</button>
            ...
            <div class="row special-list">
                <div class="col-lg-3 col-md-6 special-grid adventure">
                        ...
                        <div class="box-img-hover">
                            ...
                            <div class="mask-icon">
                                <ul>
                                    ...
                                    <p style="color: white" data-placement="right">Thailand</p>
                ...
                <div class="col-lg-3 col-md-6 special-grid modern">
                    <div class="products-single fix">
			<div class="box-img-hover">
                            <div class="type-lb">
                                <p class="new">New</p>
                            ...
                            <div class="mask-icon">
                                <ul>
                                    ...
                                    <p style="color: white" data-placement="right">London</p>
                             <!--   <li><a href="#" data-toggle="tooltip" data-placement="right" title="Add to Wishlist"><i class="far fa-heart"></i></a></li>  -->
				</ul>
                                <a class="cart" href="product.jsp">Add to Cart</a>                           
 				</div>
                ...
                <div class="col-lg-3 col-md-6 special-grid attractive">
                    <div class="products-single fix">
                        <div class="box-img-hover">
			    <div class="type-lb">
                                <p class="sale">Sale</p>
                            ...
                            <div class="mask-icon">
                                <ul>
                                    ...
                                    <p style="color: white" data-placement="right">Paris</p>
                                <!-- <li><a href="#" data-toggle="tooltip" data-placement="right" title="Add to Wishlist"><i class="far fa-heart"></i></a></li> -->
                                </ul>   
                                <a class="cart" href="product.jsp">Add to Cart</a>                             
                            </div>
                ...
                <div class="col-lg-3 col-md-6 special-grid others">
                    <div class="products-single fix">
                        <div class="box-img-hover">                            
                            ...
                            <div class="mask-icon">
                                <ul>
                                    ...
                                    <p style="color: white" data-placement="right">North America</p>
                                 <!--   <li><a href="#" data-toggle="tooltip" data-placement="right" title="Add to Wishlist"><i class="far fa-heart"></i></a></li>  -->
                                </ul>     
				<a class="cart" href="product.jsp">Add to Cart</a>                           
                            </div>
				...
				<div class="type-lb">
                            ...
                            <div class="mask-icon">
                                <ul>
                                    ...
                                    <p style="color: white" data-placement="right">Australia</p>
                                <!--    <li><a href="#" data-toggle="tooltip" data-placement="right" title="Add to Wishlist"><i class="far fa-heart"></i></a></li> -->
                                </ul>
				<a class="cart" href="product.jsp">Add to Cart</a>
                            </div>
			...
			<div class="type-lb">
                            ...
                            <div class="mask-icon">
                                <ul>
                                    ...
                                    <p style="color: white" data-placement="right">Indonesia</p>
                              <!--       <li><a href="#" data-toggle="tooltip" data-placement="right" title="Add to Wishlist"><i class="far fa-heart"></i></a></li>  -->
                                </ul>
				<a class="cart" href="product.jsp">Add to Cart</a>
                            </div>
