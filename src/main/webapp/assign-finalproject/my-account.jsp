            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
					<div class="custom-select-box">
                        <label for="currencyUSD">Currency: $ USD</label>
                    </div>
                ...
                <div class="row">
                        ...
                        <div class="account-box">
                            <div class="service-box">
                                <div class="service-icon">
                                    <a href="myOrders.jsp"> <i class="fa fa-gift"></i> </a>
                                </div>
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="account-box">
                            <div class="service-box">
                                <div class="service-icon">
                                    <a href="changeDetails.jsp"><i class="fa fa-lock"></i> </a>
                                </div>
                                <div class="service-desc">
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="account-box">
                            <div class="service-box">
                                <div class="service-icon">
                                    <a href="changeDetails.jsp"> <i class="fa fa-location-arrow"></i> </a>
                                </div>
                                <div class="service-desc">
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="account-box">
                            <div class="service-box">
                                <div class="service-icon">
                                    <a href="myCart.jsp"> <i class="fab fa-paypal"></i> </a>
                                </div>
                                <div class="service-desc">
                                    <h4>PayPal</h4>
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="account-box">
                            <div class="service-box">
                                <div class="service-icon">
                                    <a href="logout.jsp"> <i class="fab fa-amazon"></i> </a>
                                </div>
                                <div class="service-desc">
                                    <h4>Logout</h4>
